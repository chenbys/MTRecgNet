...
class RESNET18_SUNRGBD_CONFIG:
    ...
    def args(self):
        ...
        use_fake = False
        fake_rate = 0.3
        sample_path = os.path.join('A:/workspace/TRecgNet/exp/resnet18/sample_model/', content_pretrained,
                                   'PSG_BtoA.pth')
        resume = False
        resume_path = os.path.join('A:/workspace/TRecgNet/exp/resnet18/sample_model/', content_pretrained,
                                   '10k_place_AtoB.pth')
        resume_path_AtoB = os.path.join('A:/workspace/TRecgNet/exp/resnet18/sample_model/', content_pretrained,
                                        'PS_AtoB.pth')
        resume_path_BtoA = os.path.join('A:/workspace/TRecgNet/exp/resnet18/sample_model/', content_pretrained,
                                        'PS_BtoA.pth')
